      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Agregar usuario</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Agregar cliente</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Agregar distribuidor</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Ver distribuidores</a></li>
          </ul>
        </li>
      </ul>
