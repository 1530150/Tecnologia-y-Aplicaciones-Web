<?php
  ...
  class Usuarios extends Controller{
    ...
    public function index(){
      $usuarios = $this->modelo->getUsuarios($_SESSION["tienda"]);
    ...
    public function eliminar($id = ""){
      ...
      //Se valida que el usuario a eliminar no sea el mismo que el que está en sesión
      if($id != $_SESSION["id"]){
        $this->modelo->eliminarUsuario($id); //Se elimina el usuario
      }

      header("Location: " . RUTA_URL . "/public/usuarios/"); //Se regresa al index
    }
