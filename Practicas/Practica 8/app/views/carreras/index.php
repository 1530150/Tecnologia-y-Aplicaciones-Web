    ...
    <div class="section-container tabs" data-section>
      <section class="section">
        <div class="content" data-slug="panel1">
          ...
          <a href="<?php echo RUTA_URL?>/public/carreras/agregarCarrera" class="button">Agregar nuevo</a>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <?php foreach($data as $carrera): ?>
                      <tr>
                        <td><?php echo $carrera[1] ?></td>
                        <td>
                          <!-- Botones de modificar y eliminar -->
                          <a href="<?php echo RUTA_URL ?>/public/carreras/editarCarrera/<?php echo $carrera[0] ?>" class="button radius tiny secondary">Modificar</a>
                          <button name="eliminar" value="<?php echo $carrera[0] ?>" class="button radius tiny secondary">Eliminar</button>
                        </td>
                      </tr>
                    <?php endforeach ?>
                </tbody>
